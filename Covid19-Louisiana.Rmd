...
eval_model(la$positivity,preds$f, model_name = 'AR(15) With Weekly Trend', e$aic) #ASE .000647

preds <- fore.aruma.wge(la$positivity, phi = e$phi, theta = e$theta, s=7, n.ahead = 90, lastn = T, limits = F)
eval_model(la$positivity,preds$f, model_name = 'AR(15) With Weekly Trend', e$aic) #ASE .000202
...
eval_model(us$positivity,preds$f, model_name = 'ARMA(18,1) With Weekly/Monthly Trend', e$aic) #ASE .000178

preds <- fore.aruma.wge(us$positivity, phi = e$phi, theta = e$theta, s=7, n.ahead = 90, lastn = T, limits = F)
eval_model(us$positivity,preds$f, model_name = 'ARMA(18,1) With Weekly/Monthly Trend', e$aic) #ASE .000707
